...
class PsdLayer {
  ...
  int type() {
    if (additionalData.containsKey(PsdLayerSectionDivider.TAG)) {
      var section = additionalData[PsdLayerSectionDivider.TAG] as PsdLayerSectionDivider;
      return section.type;
    }
  ...
  void readImageData(InputBuffer input, PsdImage psd) {
    ...
    layerImage = PsdImage.createImageFromChannels(psd.colorMode, psd.depth, width, height, channels);
  }
}
