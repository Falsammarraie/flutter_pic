...
class PngEncoder extends Encoder {
  ...
  void addFrame(Pic image) {
    ...
    var filteredImage = Uint8List((image.width * image.height * image.numberOfChannels) + image.height);
  ...
  void _filter(Pic image, List<int> out) {
    int oi = 0;
  ...
  int _filterNone(Pic image, int oi, int row, List<int> out) {
    out[oi++] = FILTER_NONE;
  ...
  int _filterSub(Pic image, int oi, int row, List<int> out) {
    out[oi++] = FILTER_SUB;
  ...
  int _filterUp(Pic image, int oi, int row, List<int> out) {
    out[oi++] = FILTER_UP;
  ...
  int _filterAverage(Pic image, int oi, int row, List<int> out) {
  ...
  int _filterPaeth(Pic image, int oi, int row, List<int> out) {
    out[oi++] = FILTER_PAETH;
