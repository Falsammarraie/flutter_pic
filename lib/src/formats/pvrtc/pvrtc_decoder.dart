...
class PvrtcDecoder {
  ...
  Pic decodeApplePVRTC(List<int> data) {
  ...
  Pic decodePVR3(List<int> data) {
    ...
    var order = [input.readByte(), input.readByte(), input.readByte(), input.readByte()];
  ...
  Pic decodeRgb4bpp(int width, int height, TypedData data) {
    var result = Pic(width, height, channels: Channels.rgb);
  ...
  Pic decodeRgba4bpp(int width, int height, TypedData data) {
    var result = Pic(width, height, channels: Channels.rgb);
