...
Pic copyRectify(Pic src, {Point topLeft, Point topRight, Point bottomLeft, Point bottomRight, Pic toImage}) {
  Pic dst = toImage == null ? Pic.from(src) : toImage;
  for (int y = 0; y < dst.height; ++y) {
    ...
    for (int x = 0; x < dst.width; ++x) {
      ...
      Point srcPixelCoord =
          topLeft * (1 - u) * (1 - v) + topRight * (u) * (1 - v) + bottomLeft * (1 - u) * (v) + bottomRight * (u) * (v);
