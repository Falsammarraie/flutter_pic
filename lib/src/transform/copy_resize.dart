...
/// of [src] and [height].
Pic copyResize(Pic src, {int width, int height, Interpolation interpolation = Interpolation.nearest}) {
  ...
  Pic dst = Pic(width, height, channels: src.channels, exif: src.exif, iccp: src.iccProfile);
