...
class SeparableKernel {
  ...
  /// vertical axis.
  void apply(Pic src, Pic dst, {bool horizontal = true}) {
    if (horizontal) {
  ...
  void _applyCoeffsLine(Pic src, Pic dst, int y, int width, bool horizontal) {
    for (int x = 0; x < width; x++) {
      ...
      int c = getColor((r > 255.0 ? 255.0 : r).toInt(), (g > 255.0 ? 255.0 : g).toInt(),
          (b > 255.0 ? 255.0 : b).toInt(), (a > 255.0 ? 255.0 : a).toInt());
