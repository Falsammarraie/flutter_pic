...
/// contains the animation, and the [Pic] frames provide information about
...
class Animation extends IterableBase<Pic> {
  ...
  Pic operator [](int index) => frames[index];
  ...
  Pic get first => frames.first;

  /// The last frame of the animation.
  Pic get last => frames.last;
  ...
  Iterator<Pic> get iterator => frames.iterator;
}
