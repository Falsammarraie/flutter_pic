...
void main() {
  group('Color', () {
    test('RGBA', () {
      int rgba = ColorAdvanced.fromRgba(0xaa, 0xbb, 0xcc, 0xff);
    ...
    test('Grayscale', () {
      var rgba = ColorAdvanced.fromRgba(0x55, 0x66, 0x77, 0x88);
    ...
    test('Pic', () {
      ...
      for (int i = 0, len = image.length; i < len; ++i) {
        image[i] = ColorAdvanced.fromRgba(200, 128, 64, 255);
      }
      ...
      var image_argb = Pic.fromBytes(image.width, image.height, argb, format: Format.argb);
      ...
      var image_abgr = Pic.fromBytes(image.width, image.height, abgr, format: Format.abgr);
      ...
      var image_rgba = Pic.fromBytes(image.width, image.height, rgba, format: Format.rgba);
      ...
      var image_bgra = Pic.fromBytes(image.width, image.height, bgra, format: Format.bgra);
      ...
      var image_rgb = Pic.fromBytes(image.width, image.height, rgb, format: Format.rgb);
      ...
      var image_bgr = Pic.fromBytes(image.width, image.height, bgr, format: Format.bgr);
