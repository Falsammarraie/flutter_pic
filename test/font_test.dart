...
void main() {
  Pic image = readJpg(new File('test/res/jpg/big_buck_bunny.jpg').readAsBytesSync());
  ...
  group('bitmapFont', () {
    ...
    test('zip/text', () {
      ...
      var img = copyResize(image, width: 400);
      drawString(img, font, 10, 50, 'Testing Font 2: Hello World', color: getColor(255, 0, 0, 128));
    ...
    test('arial_14', () {
      var img = copyResize(image, width: 400);
      drawString(img, arial_14, 10, 50, 'Testing Arial 14: Hello World', color: getColor(255, 0, 0, 128));
    ...
    test('arial_24', () {
      var img = copyResize(image, width: 400);
      drawString(img, arial_24, 10, 50, 'Testing Arial 24: Hello World', color: getColor(255, 0, 0, 128));
    ...
    test('arial_48', () {
      var img = copyResize(image, width: 400);
      drawString(img, arial_48, 10, 50, 'Testing Arial 48: Hello World', color: getColor(255, 0, 0, 128));
