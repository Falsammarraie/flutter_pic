...
void main() {
  group('filter', () {
    ...
    test('fill', () {
      Pic f = Pic(10, 10, channels: Channels.rgb);
    ...
    test('floodFill', () {
      Pic s = readJpg(new File('test/res/oblique.jpg').readAsBytesSync());
    ...
    test('copyInto', () {
      Pic s = Pic.from(image);
      Pic d = Pic(image.width + 20, image.height + 20, channels: image.channels);
      fill(d, 0xff0000ff);
    ...
    test('add', () {
      Pic i1 = Pic.from(image);
      Pic i2 = Pic.from(image2);
      i1 += i2;
    ...
    test('copyResize', () {
      Pic f = copyResize(image, height: 100);
    ...
    test('remapColors', () {
      ...
      remapColors(f, red: Channel.green, green: Channel.red, alpha: Channel.luminance);
    ...
    test('trim', () {
      Pic image = readPng(new File('test/res/png/trim.png').readAsBytesSync());
      Pic trimmed = trim(image, mode: TrimMode.transparent);
    ...
    test('dropShadow', () {
      Pic s = Pic.from(image2);
      Pic d = dropShadow(s, 5, 5, 10);
