...
void main() {
  group('PVRTC', () {
    test('encode_rgb_4bpp', () {
      ...
      Pic image = TgaDecoder().decodeImage(bytes);
      ...
      Pic decoded = PvrtcDecoder().decodeRgb4bpp(image.width, image.height, pvrtc);
    ...
    test('encode_rgba_4bpp', () {
      ...
      Pic image = PngDecoder().decodeImage(bytes);
      ...
      Pic decoded = PvrtcDecoder().decodeRgba4bpp(image.width, image.height, pvrtc);
  ...
  group('PVR Decode', () {
    ...
    for (var f in files) {
      ...
      test(name, () {
        ...
        Pic img = PvrtcDecoder().decodePvr(bytes);
        assert(img != null);
